        ...
        <section className="py-12 md:py-16 lg:py-18">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start max-w-6xl mx-auto">
              ...
              <p className="text-foreground text-base md:text-2xl md:w-5/6 font-normal">
        ...
        <section className="pb-12 md:pb-16">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <p className="text-[#02DC3B] bg-[#EEF8F1]/50 font-medium text-xl py-2 px-3 inline-block mb-12 rounded-full">What Makes Us Different:</p>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-6">
                {differentiators.map((item) => (
                  <div key={item.title} className="bg-[#000000]/1 py-4 px-3 rounded-[12px]">
                    ...
                    <h3 className="font-medium text-2xl mb-3 text-foreground">{item.title}</h3>
                    <p className="text-muted-foreground font-normal text-lg">{item.description}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-12 md:py-16 lg:py-20">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-2xl sm:text-3xl md:text-6xl font-medium mb-6.5 text-foreground">
                Our Layered
                <br />
                Data Advantage:
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 md:gap-18">
                ...
                <div className="space-y-6 flex flex-col justify-between">
                  <p className="text-lg font-normal text-muted-foreground">
                    We operate campaigns for <span className="font-medium text-foreground">29+ brands</span> across
                    regulated and grey markets simultaneously. This gives us a unique{" "}
                    <span className="font-medium text-foreground">cross - client intelligence network</span> that
                    other agencies cant match.
                  </p>
                  <p className="text-xl md:text-lg font-medium text-muted-foreground">
                ...
                <div className="space-y-12">
                  <div className="py-6 px-4 bg-[#F1F2FF]/40 rounded-xl">
                    <h3 className="font-medium mb-3 text-2xl text-foreground">Survival technology</h3>
                    <p className="text-lg font-normal text-muted-foreground">
                      Proprietary cloaking methods keep campaigns live when competitors get banned.
                    </p>
                  </div>
                  <div className="p-5 bg-[#F1F2FF]/40 rounded-xl">
                    <h3 className="font-medium mb-3 text-2xl text-foreground">Creative diversity</h3>
                    <p className="text-lg font-normal text-muted-foreground">
                      The algorithm wars are now won and lost on creative quality and volume.
                    </p>
                  </div>
        ...
        <section className="py-12 md:py-16 lg:py-20">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-medium mb-4 text-foreground">Where We Operate</h2>
              <p className="text-lg font-normal text-muted-foreground">Top performing Geos and FTD Ranges</p>
            </div>
