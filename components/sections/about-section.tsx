...
export function AboutSection() {
  return (
    <section className="py-16 md:py-24 lg:py-24 lg:pb-10">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto mb-20 md:mb-24">
          ...
          <div className="grid lg:grid-cols-2 gap-4 lg:gap-6 md:mb-24">
            ...
            <div className="flex flex-col justify-between">
              ...
              <Button className="md:mr-auto text-base font-medium bg-primary hover:bg-primary/90 text-white cursor-pointer rounded-full px-6 md:py-3">
                Know Us Better
              </Button>
            </div>
